...
public class PhoneAuthenticationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verifyOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(edtOTP.getText().toString())) {
                    ...
                    Toast.makeText(PhoneAuthenticationActivity.this, "Please enter OTP", Toast.LENGTH_SHORT).show();
                } else {
        ...
        mCallback = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                Log.e("PhoneAuth", e.getMessage(), e);
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent i = new Intent(PhoneAuthenticationActivity.this, HomeActivity.class);
                            startActivity(i);
                            finish();
                        } else {
    ...
    private void verifyCode(String code) {
        ...
        try {
            ...
            Toast.makeText(PhoneAuthenticationActivity.this, "Verification Failed", Toast.LENGTH_LONG).show();
